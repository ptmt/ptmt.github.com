...
Германия это не только VW-Porsche/BMW/Mercedes. Это и тысячи, десятки тысяч предприятий, которые что-то производят. Семейное дело, основательное, занятие всей жизни, которое никогда не раздуется в пузырь, не станет очередным фейсбуком, просто потому что рынок для этого очень мал. Кому-то нужно производить лучшую обувь на лпанете для гигантов или станки для производства фильтров для сигарет. 

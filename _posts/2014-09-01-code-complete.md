...
Наконец-то, господа. Наконец-то. Ведь классы, это что-то связанное с кодом, да? Самое интересное начинается с самого абстрактного: абстрактных типов данных (Abstract data type). Всякие графы, мапы, хэши, стеки и другие. 
...
Торжество геттеров и сеттеров. Наверное, мне досталось старая версия книги или много занудства, подташнивает.

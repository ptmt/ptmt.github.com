...
После был сразу и Людовик XV, затем Людовик XVI, а потом и вовсе взятие Бастилии, казнь короля и французская революция. Привет, первая в мире “демократия”, равенство и братство. Звучит Марсельеза, создатели фейсбука придумают его через двести лет, в нём будут списываться современные OPPA-GANGNAM-STYLE-зиционеры. 
...
Перед нами резко оттормаживается совсем не свежий Mercedes CLK, попутно чуть не задев пару машин. Из него выходит человек с невозмутимым взглядом окидывает пространство, не закрывая за собой дверь, скрывается в открытых больших дверях складского помещения. БУМ-БУМ-БУМ, кричит музыка.
...
Есть правило — не привязывайся к своему IaaS провайдеру. Не Amazon AWS, так Rackspace; не Rackspace, так Azure; не Azure, так OpenStack, поднятый на кухне, почему нет — главное не привязываться. Но мы всё равно это делаем до тех пор, пока не наступила полная неработоспособность сервисов, крах, банкроство и ликвидация.
